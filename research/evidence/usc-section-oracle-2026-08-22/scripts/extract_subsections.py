...
Emits /tmp/silent/usc_oracle_subsec.parquet (title, section, sub); 160,209 rows.
"""
...
con.execute("COPY (SELECT DISTINCT * FROM s) TO '/tmp/silent/usc_oracle_subsec.parquet' (FORMAT PARQUET)")
