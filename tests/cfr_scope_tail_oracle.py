"""Frozen source callback before CFR note/open-ended scope handling.

Only the replaced callback is copied. Coordinate/list parsing, data classes and
subpart patterns are unchanged dependencies, not the behavior under comparison.
"""
